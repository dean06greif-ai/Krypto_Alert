...
export default function Optimizer({ onClose }) {
  ...
  const applyParams = async () => {
    ...
    try {
      ...
      setApplied(true);
      toast.success('Beste Parameter in die Strategie-Einstellungen übernommen');
    } catch { toast.error('Verbindungsfehler'); }
  };
              ...
              <>
                ...
                {!result.best?.is_baseline && (
                  <>
                    ...
                    <button className="opt-apply" onClick={applyParams} disabled={applied} data-testid="opt-apply-params">
