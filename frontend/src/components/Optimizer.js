...
import { X, Play, MagicWand, Trophy, CheckCircle, FloppyDisk, ChartLine } from '@phosphor-icons/react';
  ...
  useEffect(() => {
    try {
      localStorage.setItem(STATE_KEY, JSON.stringify({
        ...
        minTrades, maxRules, indicators, optFlags, algorithm, baseStrategy,
      }));
    } catch { /* ignore */ }
  }, [mode, selStrategy, selCoins, days, timeframe, objective, iterations,
    minTrades, maxRules, indicators, optFlags, algorithm, baseStrategy]);
